 ...
 */
class dandelionbox extends ModeleBoxes
{

    public $boxcode = "mybox";
    public $boximg = "dandelion@dandelion";
    public $boxlabel;
    public $depends = array("dandelion");
    public $db;
    public $param;
    ...
    public function loadBox($max = 5)
    {
        ...
        //include_once DOL_DOCUMENT_ROOT . "/dandelion/class/dandelion.class.php";
